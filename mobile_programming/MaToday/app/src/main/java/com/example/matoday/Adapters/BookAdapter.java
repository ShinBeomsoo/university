...
import com.example.matoday.MyBook;
...
public class BookAdapter extends RecyclerView.Adapter<BookAdapter.ViewHolder> {
    ...
    private MyBook activity;
    private MyMovie activity_movie;

    public BookAdapter(DatabaseHandler db, MyBook activity) {
        this.db = db;
        this.activity = activity;
    }

    public BookAdapter(DatabaseHandler db, MyMovie activity) {
        this.db = db;
        this.activity_movie = activity;
    }
